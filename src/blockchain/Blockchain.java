...
public class Blockchain{
	...
	private static String securityPass = "09";
	private int autogeneratedTokens = 1000;
	...
	private Blockchain() {
		this.current = new Block("", new Transaction[0] , "GenesisBlock", 0, "Alejandro Rodríguez");
	}
	...
	private void addNewBlock (Account miner){
		...
		Block b = new Block(current.getHash(), getCurrentTransactions(), proofOfWork(), current.getIndex()+1, miner.getNickname());
	...
	private void generateTokens() {
		if(getNumberOfBlocks()%10 == 0) {
			setAutogeneratedTokens(getAutogeneratedTokens() + 1000);
		}
	}
	
	public int getAutogeneratedTokens() {
		return autogeneratedTokens;
	}

	public void setAutogeneratedTokens(int autogeneratedTokens) {
		this.autogeneratedTokens = autogeneratedTokens;
	}
	...
	private double generatePrize() { return new Random().nextDouble()*(1.5-0.5) + 0.5; }
	...
	public double getTotalTokens() { return accounts.stream().mapToDouble(a -> a.getAmount()).sum() + getAutogeneratedTokens();}
	
	public double getMarketCapitalization() { return getTotalTokens() * generatePrize(); }
